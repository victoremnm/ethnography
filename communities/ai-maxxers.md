# AI Maxxers & e/acc Culture

## Who They Are

AI maxxers are a techno-optimist subculture holding that accelerating AI development as fast as possible is a moral imperative. They cluster on X (Twitter) under the **e/acc** (Effective Accelerationism) banner and intersect heavily with crypto communities through shared ideological DNA: anti-paternalism, permissionless systems, and distrust of institutional gatekeepers.

Origins: a May 2022 pseudonymous newsletter by `@BasedBeffJezos` (Guillaume Verdon), `@bayeslord`, `@zestular`, `@creatine_cycle`. Went mainstream in 2023 when Marc Andreessen and Garry Tan added "e/acc" to their X profiles. Post-2024 election, found political air cover with Musk's government role and anticipated deregulation.
