...
- [AI-Based Crypto Tokens: Critical Review — arXiv (academic survey, Section 4 challenge taxonomy is primary source for "API Tether" critique)](https://arxiv.org/html/2505.07828v2)
- [Grayscale: AI Is Coming — Crypto Can Help Make It Right](https://research.grayscale.com/reports/ai-is-coming-crypto-can-help-make-it-right)
- [cyber.fund AI × Crypto Investment Thesis 2025](https://cyber.fund/content/crypto-ai-investment-thesis-2025)
